...
import 'package:notes_app/blocs/database.bloc.dart';
import 'package:notes_app/blocs/database.state.dart';
import 'package:notes_app/blocs/todo.bloc.dart';
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: <Widget>[
          TextButton(
            onPressed: () async {
              var data = await _todoBloc?.getFromApi();
