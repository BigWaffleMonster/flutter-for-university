...
import 'package:notes_app/blocs/todo.state.dart';
import 'package:notes_app/models/todo.model.dart';
import 'package:notes_app/repositories/todo.repo.dart';
...
class TodoBloc extends Cubit<TodoState> {
  ...
  Future<TodoFromApi> getFromApi() async {
    try {
      var todo = await _todoRepo.fetchTodo();
      log(todo.toString());
      return todo;
    } catch (e) {
      log(e.toString());
      return const TodoFromApi(
          userId: 0, id: 0, title: 'titlqe', completed: false);
    }
  }
}
